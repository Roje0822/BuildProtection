package xyz.chide1.buildprotection.builder;
...
public class ItemBuilder {
    ...
    public UUID getOwner() {
        Preconditions.checkNotNull(((SkullMeta) meta).getOwningPlayer(), "소유자 UUID(owner)가 null입니다.");
        return ((SkullMeta) meta).getOwningPlayer().getUniqueId();
    }
    ...
    public ItemBuilder setPDC(String value) {
